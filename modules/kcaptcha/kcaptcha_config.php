...
$allowed_symbols = "23456789abcdegikpqsvwxyz"; #alphabet without similar symbols (o=0, 1=l, i=j, t=f)
...
$white_noise_density=1/15;
//$black_noise_density=0; // no black noise
$black_noise_density=1/60;
...
//$credits = $config_ini['site_name']; # if empty, HTTP_HOST will be shown

# CAPTCHA image colors (RGB, 0-255)
$foreground_color = array(40, 40, 50);
$background_color = array(220, 233, 241);
